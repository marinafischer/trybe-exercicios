...
//   const mensagem = `Mars temperature is: ${getMarsTemperature()} degree Celsius`
//   setTimeout(()=>console.log(mensagem), messageDelay())
// }
...
const sendMarsTemperature = (callback) => {
  ...
  return setTimeout(()=>callback(temperatura), messageDelay())
}  
...
//   const probabilidadeSucesso = Math.random() >= 0.4;
//   const temperatura = getMarsTemperature();
//   const mensagemErro = 'Impossível obter a temperatura';
//   setTimeout(()=>{
//     if(probabilidadeSucesso) callback(temperatura);
//     else callbackErro(mensagemErro);
//   }, messageDelay())
// }
